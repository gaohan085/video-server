...
import { type DirectoryChildElem, getSubDir } from "../../src/getChildDIr";
      ...
      ? res.send({
          parentFolder:
            pathFromUrl === ""
              ...
              ? pathFromUrl
                  .slice(1, pathFromUrl.lastIndexOf("/") + 1)
                  .slice(0, pathFromUrl.lastIndexOf("/") + 1) //文件夹
              : pathFromUrl,

          currentPath:
            pathFromUrl === ""
              ? "/"
              : pathFromUrl.slice(1, pathFromUrl.lastIndexOf("/") + 1),
